...
private let reuseIdentifier = "SocialCell"



class SocialViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout ,UITextFieldDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        ref.child("Social").observe(.childAdded) { (snap: FIRDataSnapshot) in
